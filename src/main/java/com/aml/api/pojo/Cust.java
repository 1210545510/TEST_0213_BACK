...
public class Cust {
    ...
    private List<CustAddr> custAddrs;//客户地址
    
    private List<CustEmailAddr> custEmailAddrs;//客户邮箱
    
    private List<CustPhon> custPhons;//客户电话
    
    private List<Acct> accts;//客户账号
    
    private String cityName;//城市名称
    
    private String countryName;//国家的名字
    
    private String regionName;//地区的名字
	...
	public List<CustAddr> getCustAddrs() {
		return custAddrs;
	}

	public List<CustEmailAddr> getCustEmailAddrs() {
		return custEmailAddrs;
	}

	public List<CustPhon> getCustPhons() {
		return custPhons;
	}

	public void setCustAddrs(List<CustAddr> custAddrs) {
		this.custAddrs = custAddrs;
	}

	public void setCustEmailAddrs(List<CustEmailAddr> custEmailAddrs) {
		this.custEmailAddrs = custEmailAddrs;
	}

	public void setCustPhons(List<CustPhon> custPhons) {
		this.custPhons = custPhons;
	}
