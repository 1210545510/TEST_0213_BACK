...
public class SarFinancialInstitutionDto extends BaseDto {
	private static final long serialVersionUID = 5130334631151322470L;
	...
	private List<SarFinancialInstitutionBranchDto> branch;
	...
	public List<SarFinancialInstitutionBranchDto> getBranch () {
		return branch;
	}

	public void setBranch ( List<SarFinancialInstitutionBranchDto> branch ) {
		this.branch = branch;
	}
}