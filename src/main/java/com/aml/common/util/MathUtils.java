...
public class MathUtils {
	 ...
	 * @throw
	 */
	public static double divideTwoBigDecimal ( Object first, Object second ) {
		BigDecimal bdFirst = new BigDecimal(String.valueOf(first));
		BigDecimal bdSecond = new BigDecimal(String.valueOf(second));
		return bdFirst.divide(bdSecond, 10, BigDecimal.ROUND_HALF_UP).setScale(2, BigDecimal.ROUND_HALF_UP)
				.doubleValue();
	}

	/**
	 * 
	 * multiplyTwoBigDecimal 两数相除
	 * 
	 * @param first 第一个数
	 * @param second 第二个数
	 * @return BigDecimal
	 * @throw
	 */
	public static double divideTwoBigDecimalInt ( Object first, Object second ) {
		BigDecimal bdFirst = new BigDecimal(String.valueOf(first));
		BigDecimal bdSecond = new BigDecimal(String.valueOf(second));
		// double a = Double.parseDouble(String.valueOf(first))/Double.parseDouble(String.valueOf(first));
		// BigDecimal b = new BigDecimal(a);
		return bdFirst.divide(bdSecond, 10, BigDecimal.ROUND_HALF_UP).setScale(2, BigDecimal.ROUND_HALF_UP).intValue();
	}

	public static void main ( String[] args ) {
		System.out.println(divideTwoBigDecimalInt(11, 7));
	}
