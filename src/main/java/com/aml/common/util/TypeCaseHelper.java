...
import com.aml.common.core.exception.TypeCastException;
...
public class TypeCaseHelper {
	 ...
	 * 转换核心实现方法 <br>
	 * 使用方法：
	 * <code>Object obj = TypeCaseHelper.convert(get(key), "BigDecimal", null);</code>
	 * <code>Object obj = TypeCaseHelper.convert(get(key), "Date", "yyyy-MM-dd");</code>
	 * <code>Object obj = TypeCaseHelper.convert(get(key), "Timestamp", "yyyy-MM-dd HH:mm:ss");</code>
	 * 
	 * @param obj
	 * @param type
	 * @param format
	 ...
	 * @return
	 */
	public static <T> String getAsString(T t) {
		if (t == null){
			return "";
		}
		...
		if (t instanceof java.util.Date) {
			return DateFormatUtils.format((java.util.Date) t, "yyyy-MM-dd");
		}
		return t.toString();
	}
}
